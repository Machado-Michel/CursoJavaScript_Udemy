...
document.body.innerHTML += `Qual o ultimo índice da letra <strong>A</strong> no seu nome? <strong>${nome.lastIndexOf('a')}</strong>.<br/>`;
...
document.body.innerHTML += `Seu nome com letras Maiúsculas: <strong>${nome.toLowerCase()}</strong>.`;